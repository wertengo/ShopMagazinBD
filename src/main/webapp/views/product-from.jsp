...
<c:set var="contentPage" value="product-form-content.jsp" />
<c:set var="pageTitle" value="${product != null ? 'Редактирование товара' : 'Добавление товара'}" />
<c:set var="activePage" value="products" />
<jsp:include page="base.jsp" />

<!-- product-form-content.jsp -->
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form action="products" method="post" onsubmit="return validateForm(this)">
