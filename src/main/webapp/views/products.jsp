...
<c:set var="contentPage" value="products-content.jsp" />
<c:set var="pageTitle" value="Управление товарами" />
<c:set var="activePage" value="products" />
<jsp:include page="base.jsp" />

<!-- products-content.jsp -->
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <span class="badge bg-secondary">Всего: ${totalRecords}</span>
    </div>
    <div class="card-body">
